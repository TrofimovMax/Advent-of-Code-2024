...
def parse_file(filename):
    """Parse the input file into a doubly linked list and a movement stack."""
        ...
        if next_node.value == '.':
            ...
            if after_next and after_next.value == '.':
                ...
                for box in reversed(trail):
                    direction_map[direction](box).value = 'O'
                    box.value = '.'
...
def warehouse_woes(filename: str):
    ...
    nodes = build_doubly_linked_list(warehouse_map)
